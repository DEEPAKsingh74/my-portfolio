            ...
            <div className="mb-8">
                ...
                <div className="space-y-3">
                    <div className="flex items-center">
                        ...
                        <a href="tel:+917817952574" className="text-sm hover:text-indigo-200 transition">+91 7817952574</a>
                    </div>
                    <div className="flex items-center">
                        <svg className="w-5 h-5 text-indigo-300 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                        <a href="mailto:deepak74singh17@gmail.com" className="text-sm hover:text-indigo-200 transition">deepak74singh17@gmail.com</a>
                    </div>
                </div>
            </div>
